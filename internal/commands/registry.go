...
func Builtins() []Command {
	return []Command{
		...
		{Name: "rmdir", Run: commandRmdir}, {Name: "cp", Run: commandCPParity},
		{Name: "mv", Run: commandMV}, {Name: "ln", Run: commandLNParity},
		{Name: "chmod", Run: commandChmod}, {Name: "stat", Run: commandStat},
		{Name: "file", Run: commandFile}, {Name: "tree", Run: commandTree},
		{Name: "du", Run: commandDu}, {Name: "split", Run: commandSplit},
